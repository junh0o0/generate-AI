...
#preference = st.text_input("여행지가 어땠으면 좋겠는지 알려주세요. ex) 가성비가 좋아야해요, 사진 찍기 좋았으면 좋겠어요")
preference = st.text_input(r"$\textsf{\Large Please let me know what you want the destination to be. ex) It should be cost-effective, I hope it's good for taking pictures}$")
